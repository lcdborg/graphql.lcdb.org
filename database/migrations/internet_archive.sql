CREATE TABLE Collection_InternetArchive (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_B56B2C2F5E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = MyISAM;
CREATE TABLE Creator_InternetArchive (id INT AUTO_INCREMENT NOT NULL, artist_id INT UNSIGNED DEFAULT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_F769A7625E237E06 (name), INDEX IDX_F769A762B7970CF8 (artist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = MyISAM;
CREATE TABLE File_InternetArchive (id INT AUTO_INCREMENT NOT NULL, identifier_id INT NOT NULL, name VARCHAR(255) NOT NULL, body LONGTEXT DEFAULT NULL, INDEX IDX_D0DB8096EF794DF6 (identifier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = MyISAM;
...
CREATE TABLE CollectionToIdentifier_InternetArchive (identifier_id INT NOT NULL, collection_id INT NOT NULL, INDEX IDX_3CE1696CEF794DF6 (identifier_id), INDEX IDX_3CE1696C514956FD (collection_id), PRIMARY KEY(identifier_id, collection_id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = MyISAM;
