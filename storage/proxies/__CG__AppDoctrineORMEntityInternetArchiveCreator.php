 ...
 */
class Creator extends \App\Doctrine\ORM\Entity\InternetArchive\Creator implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Doctrine\\ORM\\Entity\\InternetArchive\\Creator' . "\0" . 'name', '' . "\0" . 'App\\Doctrine\\ORM\\Entity\\InternetArchive\\Creator' . "\0" . 'id', '' . "\0" . 'App\\Doctrine\\ORM\\Entity\\InternetArchive\\Creator' . "\0" . 'identifiers', '' . "\0" . 'App\\Doctrine\\ORM\\Entity\\InternetArchive\\Creator' . "\0" . 'artist'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Creator $proxy) {
