 ...
 */
class ArtistUnprefix extends \App\Doctrine\ORM\Entity\ArtistUnprefix implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Doctrine\\ORM\\Entity\\ArtistUnprefix' . "\0" . 'name', '' . "\0" . 'App\\Doctrine\\ORM\\Entity\\ArtistUnprefix' . "\0" . 'nameUnprefix', '' . "\0" . 'App\\Doctrine\\ORM\\Entity\\ArtistUnprefix' . "\0" . 'top100', '' . "\0" . 'App\\Doctrine\\ORM\\Entity\\ArtistUnprefix' . "\0" . 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ArtistUnprefix $proxy) {
