 ...
 */
class ArtistUnprefixSource extends \App\ORM\Entity\ArtistUnprefixSource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\ORM\\Entity\\ArtistUnprefixSource' . "\0" . 'name', '' . "\0" . 'App\\ORM\\Entity\\ArtistUnprefixSource' . "\0" . 'nameUnprefix', '' . "\0" . 'App\\ORM\\Entity\\ArtistUnprefixSource' . "\0" . 'top100', '' . "\0" . 'App\\ORM\\Entity\\ArtistUnprefixSource' . "\0" . 'id'];
        }
