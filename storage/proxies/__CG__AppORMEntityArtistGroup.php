 ...
 */
class ArtistGroup extends \App\ORM\Entity\ArtistGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\ORM\\Entity\\ArtistGroup' . "\0" . 'title', '' . "\0" . 'App\\ORM\\Entity\\ArtistGroup' . "\0" . 'header', '' . "\0" . 'App\\ORM\\Entity\\ArtistGroup' . "\0" . 'footer', '' . "\0" . 'App\\ORM\\Entity\\ArtistGroup' . "\0" . 'id', '' . "\0" . 'App\\ORM\\Entity\\ArtistGroup' . "\0" . 'artistToArtistGroups', '' . "\0" . 'App\\ORM\\Entity\\ArtistGroup' . "\0" . 'userToArtistGroups', '' . "\0" . 'App\\ORM\\Entity\\ArtistGroup' . "\0" . 'user'];
        }
