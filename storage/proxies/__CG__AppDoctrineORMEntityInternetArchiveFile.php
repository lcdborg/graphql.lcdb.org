 ...
 */
class File extends \App\Doctrine\ORM\Entity\InternetArchive\File implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Doctrine\\ORM\\Entity\\InternetArchive\\File' . "\0" . 'name', '' . "\0" . 'App\\Doctrine\\ORM\\Entity\\InternetArchive\\File' . "\0" . 'body', '' . "\0" . 'App\\Doctrine\\ORM\\Entity\\InternetArchive\\File' . "\0" . 'id', '' . "\0" . 'App\\Doctrine\\ORM\\Entity\\InternetArchive\\File' . "\0" . 'identifier'];
        }
